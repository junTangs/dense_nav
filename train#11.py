...
parser.add_argument("--env_config", type=str,default=r"config/env_config/env_40h.json",help="env config file path")
parser.add_argument("--rl_config", type=str, default = r"config/rl_config/dqn_sa_config.json",help="rl config file path")
...
parser.add_argument("--name",type=str,default = "v2_sa2_40_rgs",help="experiment name")
