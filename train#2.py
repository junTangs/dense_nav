...
parser.add_argument("--env_config", type=str,default=r"config/env_config/env_60h.json",help="env config file path")
...
parser.add_argument("--name",type=str,default = "v2_60_rgs",help="experiment name")
