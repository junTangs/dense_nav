...
parser.add_argument("--rl_config", type=str, default = r"config/rl_config/dqn_v3_config.json",help="rl config file path")
...
parser.add_argument("--name",type=str,default = "v3_40_rgs",help="experiment name")
